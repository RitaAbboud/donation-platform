...
export default function Hero() {
 ...
 return (
  <section className="relative bg-[#fdf2e9] overflow-hidden min-h-[90vh] flex items-center">
    ...
    <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-[#f8d5b8] rounded-full blur-3xl opacity-40" />
    ...
    <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <h1 className= "text-5xl md:text-6xl lg:text-7xl mb-6  text-slate-900">
          One Hand <br />
      ...
      {/* RIGHT IMAGE AREA - "MELTED" DESIGN */}
      <div
      ...
      >
        <div className="relative w-full aspect-square max-w-[480px] mx-auto flex items-center justify-center">
          {/* Soft outer glow to melt with background */}
          <div className="absolute inset-0 bg-[#e25e2d] rounded-full blur-3xl transform scale-75" />
    ...
    {/* SINGLE BOTTOM WAVE TRANSITION */}
    <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none line-height-0">
      <svg 
