...
import { UserPlus, ArrowLeft, Loader2, Mail, Lock, ShieldCheck } from "lucide-react";
      ...
      <div className="hidden lg:flex flex-col justify-center p-12 xl:p-20 bg-[#f8d5b8] relative overflow-hidden">
        ...
        <div className="max-w-md relative z-10">
          ...
          <p className="text-lg text-[#333333]/70 font-light leading-relaxed">
            Join a community of dedicated givers. Setting up your profile takes less than a minute.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 md:p-16 lg:p-20">
        <div className="w-full max-w-sm mx-auto">
          ...
          <div className="mb-8 sm:mb-10">
            <h1 className="text-3xl sm:text-4xl font-bold text-[#222222] tracking-tight">Create Account</h1>
            <p className="text-gray-400 mt-3 text-base sm:text-lg font-light">Start your journey today.</p>
          </div>

          <form onSubmit={handleSubmitButton} className="space-y-6 sm:space-y-8">
            ...
            {msg && (
              <div className={`text-sm p-3 rounded-lg ${msg === 'success' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-500'} animate-in fade-in duration-300`}>
          ...
          <p className="mt-8 sm:mt-10 text-center text-sm sm:text-base text-gray-400">
            Already a member? <a href="/login" className="text-[#e25e2d] font-bold hover:underline underline-offset-4">Log In</a>
          </p>
        </div>
      </div>
    </div>
