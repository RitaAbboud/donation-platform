...
{/* Terms and Conditions - Thumb Optimized */}
<div className="flex items-center group cursor-pointer">
  <input 
    type="checkbox" 
    id="terms"  
    className="w-4 h-4 rounded border-gray-300 text-[#e25e2d] focus:ring-[#e25e2d] cursor-pointer" 
    // Use 'checked' for checkboxes, never 'value'
    checked={!!isagree} 
    onChange={() => setIsagree(!isagree)}
  />
  <label htmlFor="terms" className="ml-3 text-sm text-gray-500 cursor-pointer select-none">
    I agree to the{" "}
    <a href="/terms" className="text-[#e25e2d] font-semibold hover:underline">
      Terms of Service
    </a>
  </label>
</div>
          ...
          {msg && (
            <div
              className={`text-sm p-4 rounded-xl border animate-in fade-in slide-in-from-top-1 duration-300 ${
                msg === "success" 
        ...
        <p className="mt-8 sm:mt-10 text-center text-sm sm:text-base text-gray-400">
          ...
          <a
            href="/login"
            className="text-[#e25e2d] font-bold hover:underline underline-offset-4 decoration-2"
          >
            Log In
          </a>
        </p>
