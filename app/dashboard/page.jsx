      ...
      <div className={`min-h-screen text-slate-800 ${poppins.className}`}>
          ...
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-1.5 border rounded-full text-xs font-bold transition-all ${showFilters ? "bg-[#e25e2d] text-white" : "bg-white text-[#e25e2d]"
                  }`}
              >
        ...
        <div className="mt-12 flex flex-col items-center gap-8">
          ...
          <div className="flex justify-center gap-8 md:gap-16 px-6">
            {categories.map((cat) => {
              // If no category is selected yet, treat all as "active"
